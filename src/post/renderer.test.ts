...
import type { legendsSchema } from "./libType";
      ...
      [
        {
          ...
          data: [
            {
              stepName: undefined,
              stackedBarData: twoMetricsInfoList,
              times: threeTimes,
              yAxis: {
                title: "%",
                range: "0 --> 100",
